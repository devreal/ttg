...
namespace ttg {
  ...
  namespace meta {
    ...
    namespace detail {
      ...
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      template <typename Key, typename Ret, typename Enabler = void>
      struct keymap;
      template <typename Key, typename Ret>
      struct keymap<Key, Ret, std::enable_if_t<!is_void_v<Key>>> {
        using type = std::function<Ret(const Key &)>;
      };
      template <typename Key, typename Ret>
      struct keymap<Key, Ret, std::enable_if_t<is_void_v<Key>>> {
        using type = std::function<Ret()>;
      };
      template <typename Key, typename Ret = int>
      using keymap_t = typename keymap<Key, Ret>::type;
